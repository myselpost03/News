...
const EntertainmentNews = () => {
  ...
  const [combinedEntertainmentNews, setCombinedEntertainmentNews] = useState(
    []
  );
      ...
      try {
        ...
        if (country) {
          responseArray = await Promise.all([
            axios.get(`${BASE_URL}/news/etonline?page=${page}`),
            axios.get(`${BASE_URL}/news/billboard?page=${page}`),
            axios.get(`${BASE_URL}/news/hollywoodreporter?page=${page}`),
            axios.get(`${BASE_URL}/news/deadline?page=${page}`),
            axios.get(`${BASE_URL}/news/variety?page=${page}`),
          ]);
        } else {
          setCombinedEntertainmentNews([]);
          setIsLoading(false);
          return;
        }
        ...
        setCombinedEntertainmentNews(combinedNews);
      } catch (error) {
      ...
      <div className="news__card-cont">
        {isLoading ? (
          ...
          <>
            ...
            {combinedEntertainmentNews.length > visibleCards && (
              <button
