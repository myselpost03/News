    ...
    try {
      ...
      if (country) {
        responseArray = await Promise.all([
          axios.get(`${BASE_URL}/news/insidehigh?page=${page}`),
          axios.get(`${BASE_URL}/news/theconversationeducation?page=${page}`),
          axios.get(`${BASE_URL}/news/educationnext?page=${page}`),
          axios.get(`${BASE_URL}/news/hechingerreport?page=${page}`),
        ]);
      } else {
