...
const ScienceNews = () => {
  ...
  const [combinedScienceNews, setCombinedScienceNews] = useState([]);
      ...
      try {
        ...
        if (country) {
          responseArray = await Promise.all([
            axios.get(`${BASE_URL}/news/spacenews?page=${page}`),
            axios.get(`${BASE_URL}/news/livescience?page=${page}`),
            axios.get(`${BASE_URL}/news/physics?page=${page}`),
            axios.get(`${BASE_URL}/news/newsscientist?page=${page}`),
          ]);
        } else {
          setCombinedScienceNews([]);
          setIsLoading(false);
          return;
        }
        ...
        setCombinedScienceNews(combinedNews);
      } catch (error) {
      ...
      <div className="news__card-cont">
        {isLoading ? (
          ...
          <>
            ...
            {combinedScienceNews.length > visibleCards && (
              <button
