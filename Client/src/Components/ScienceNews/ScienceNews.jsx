    ...
    try {
      ...
      if (country) {
        responseArray = await Promise.all([
          axios.get(`${BASE_URL}/news/spacenews`),
          axios.get(`${BASE_URL}/news/livescience`),
          axios.get(`${BASE_URL}/news/physics`),
          axios.get(`${BASE_URL}/news/newsscientist`),
        ]);
      } else {
    ...
    <>
      <div className="news__card-cont">
        {isLoading ? (
          ...
          <>
            {renderNewsArticles(combinedScienceNews)}
