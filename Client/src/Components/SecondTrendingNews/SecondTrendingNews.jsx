    ...
    try {
      ...
      if (country) {
        responseArray = await Promise.all([
          axios.get(`${BASE_URL}/news/apisrael`),
          axios.get(`${BASE_URL}/news/guardianisrael`),
          axios.get(`${BASE_URL}/news/jpost`),
          axios.get(`${BASE_URL}/news/bbcisrael`),
        ]);
      } else {
    ...
    <>
      <div className="news__card-cont">
        {isLoading ? (
          ...
          <>
            {renderNewsArticles(combinedSecondTrendingNews)}
