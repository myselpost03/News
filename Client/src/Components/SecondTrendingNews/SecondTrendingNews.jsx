...
const SecondTrendingNews = () => {
  ...
  const [combinedSecondTrendingNews, setCombinedSecondTrendingNews] = useState(
    []
  );
      ...
      try {
        ...
        if (country) {
          responseArray = await Promise.all([
            axios.get(`${BASE_URL}/news/apisrael?page=${page}`),
            axios.get(`${BASE_URL}/news/guardianisrael?page=${page}`),
            axios.get(`${BASE_URL}/news/jpost?page=${page}`),
            axios.get(`${BASE_URL}/news/bbcisrael?page=${page}`),
          ]);
        } else {
          setCombinedSecondTrendingNews([]);
          setIsLoading(false);
          return;
        }
        ...
        setCombinedSecondTrendingNews(combinedNews);
      } catch (error) {
      ...
      <div className="news__card-cont">
        {isLoading ? (
          ...
          <>
            ...
            {combinedSecondTrendingNews.length > visibleCards && (
              <button
...
export default SecondTrendingNews;
