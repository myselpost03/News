    ...
    try {
      ...
      if (country) {
        responseArray = await Promise.all([
          axios.get(`${BASE_URL}/news/techcrunch`),
          axios.get(`${BASE_URL}/news/lifehacker`),
          axios.get(`${BASE_URL}/news/wired`),
          axios.get(`${BASE_URL}/news/verge`),
          axios.get(`${BASE_URL}/news/zdnet`),
          axios.get(`${BASE_URL}/news/gadget360`),
        ]);
      } else {
        setCombinedTechNews([]);
        setIsLoading(false);
    ...
    <>
      <div className="news__card-cont">
        {isLoading ? (
          ...
          <>
            {renderNewsArticles(combinedTechNews)}
