    ...
    try {
      ...
      if (country) {
        responseArray = await Promise.all([
          axios.get(`${BASE_URL}/news/espn`),
          axios.get(`${BASE_URL}/news/fourfourtwo`),
          axios.get(`${BASE_URL}/news/eurosport`),
          axios.get(`${BASE_URL}/news/cbssport`),
        ]);
      } else {
    ...
    <>
      <div className="news__card-cont">
        {isLoading ? (
          ...
          <>
            {renderNewsArticles(combinedSportsNews)}
