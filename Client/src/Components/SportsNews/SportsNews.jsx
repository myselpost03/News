...
const SportsNews = () => {
  ...
  const [combinedSportsNews, setCombinedSportsNews] = useState([]);
      ...
      try {
        ...
        if (country) {
          responseArray = await Promise.all([
            axios.get(`${BASE_URL}/news/espn?page=${page}`),
            axios.get(`${BASE_URL}/news/fourfourtwo?page=${page}`),
            axios.get(`${BASE_URL}/news/eurosport?page=${page}`),
            axios.get(`${BASE_URL}/news/cbssport?page=${page}`),
          ]);
        } else {
          setCombinedSportsNews([]);
          setIsLoading(false);
          return;
        }
        ...
        setCombinedSportsNews(combinedNews);
      } catch (error) {
      ...
      <div className="news__card-cont">
        {isLoading ? (
          ...
          <>
            ...
            {combinedSportsNews.length > visibleCards && (
              <button
