    ...
    try {
      ...
      if (country) {
        responseArray = await Promise.all([
          axios.get(`${BASE_URL}/news/euromaid`),
          axios.get(`${BASE_URL}/news/apnews`),
          axios.get(`${BASE_URL}/news/bbcukraine`),
          axios.get(`${BASE_URL}/news/nytukraine`),
        ]);
      } else {
    ...
    <>
      <div className="news__card-cont">
        {isLoading ? (
          ...
          <>
            {renderNewsArticles(combinedFirstTrendingNews)}
