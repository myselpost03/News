...
const FirstTrendingNews = () => {
  ...
  const [combinedFirstTrendingNews, setCombinedFirstTrendingNews] = useState(
    []
  );
      ...
      try {
        ...
        if (country) {
          responseArray = await Promise.all([
            axios.get(`${BASE_URL}/news/euromaid?page=${page}`),
            axios.get(`${BASE_URL}/news/apnews?page=${page}`),
            axios.get(`${BASE_URL}/news/bbcukraine?page=${page}`),
            axios.get(`${BASE_URL}/news/nytukraine?page=${page}`),
          ]);
        } else {
          setCombinedFirstTrendingNews([]);
          setIsLoading(false);
          return;
        }
        ...
        setCombinedFirstTrendingNews(combinedNews);
      } catch (error) {
      ...
      <div className="news__card-cont">
        {isLoading ? (
          ...
          <>
            ...
            {combinedFirstTrendingNews.length > visibleCards && (
              <button
...
export default FirstTrendingNews;
