  ...
  const fetchData = useCallback(async (page) => {
    try {
      ...
      const responseArray = await Promise.all([
        axios.get(`${BASE_URL}/news/marketbusiness?page=${page}`),
        axios.get(`${BASE_URL}/news/ibtimes?page=${page}`),
        axios.get(`${BASE_URL}/news/vox?page=${page}`),
        axios.get(`${BASE_URL}/news/fortune?page=${page}`),
        axios.get(`${BASE_URL}/news/businessinsider?page=${page}`),
      ]);
