...
const FashionNews = () => {
  ...
  const [combinedFashionNews, setCombinedFashionNews] = useState([]);
      ...
      try {
        ...
        if (country) {
          responseArray = await Promise.all([
            axios.get(`${BASE_URL}/news/fashionrogue?page=${page}`),
            axios.get(`${BASE_URL}/news/businessofffashion?page=${page}`),
            axios.get(`${BASE_URL}/news/glamour?page=${page}`),
            axios.get(`${BASE_URL}/news/glaziamagazine?page=${page}`),
            axios.get(`${BASE_URL}/news/coveteur?page=${page}`),
          ]);
        } else {
          setCombinedFashionNews([]);
          setIsLoading(false);
          return;
        }
        ...
        setCombinedFashionNews(combinedNews);
      } catch (error) {
      ...
      <div className="news__card-cont">
        {isLoading ? (
          ...
          <>
            ...
            {combinedFashionNews.length > visibleCards && (
              <button
