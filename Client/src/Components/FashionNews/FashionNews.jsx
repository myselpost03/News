    ...
    try {
      ...
      if (country) {
        responseArray = await Promise.all([
          axios.get(`${BASE_URL}/news/fashionrogue`),
          axios.get(`${BASE_URL}/news/businessofffashion`),
          axios.get(`${BASE_URL}/news/glamour`),
          axios.get(`${BASE_URL}/news/glaziamagazine`),
          axios.get(`${BASE_URL}/news/coveteur`),
        ]);
      } else {
    ...
    <>
      <div className="news__card-cont">
        {isLoading ? (
          ...
          <>
            {renderNewsArticles(combinedFashionNews)}
